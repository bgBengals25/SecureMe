...
class InitGUI():
	...
	def build(self):
		...
		self.notebook.add(basicFrame, text='Basic', font=self.liberation_font_10)
		self.notebook.add(usersFrame, text='Users', font=self.liberation_font_10)
		self.notebook.add(updateFrame, text='Updates', font=self.liberation_font_10)
		self.notebook.add(firewallFrame, text='Firewall', font=self.liberation_font_10)
